...
function colorPromise() {
    return new Promise((resolve, reject) => {
        setTimeout(() => { // till 1 sec code will stop here and after resolve is called and code resumes.
            resolve();
        }, 1000);
    })
}
    ...
    for (let children = 0; children < graphComponentMatrix[srcr][srcc].length; children++) {
        ...
        if (visited[nbrr][nbrc] === false) {
            ...
            if (response === true) {
                ...
                await colorPromise(); // till this promise is resolved code won't move forward
